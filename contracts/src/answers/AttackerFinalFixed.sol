...
contract AttackerFinalFixed {
    ...
    function drain() external {
        // Fix: Use exact approved allowance (1,000,000) instead of incorrect large number
        naughtCoin.transferFrom(player, address(this), 1000000);
    }
}